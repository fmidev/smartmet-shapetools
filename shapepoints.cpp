 ...
 * <dt>-d [distance]</dt>
 * <dd>The required minimum distance between the points in pixels (default 10)</dd>
 * <dt>-D [distance]</dt>
...
void select_points(PointSelector & theSelector,
  ...
  for(NFmiEsriShape::elements_type::size_type i = 0; i < elements.size(); i++)
	{
	  ...
	  const double value = (atype == kFmiEsriInteger ?
							elements[i]->GetInteger(options.fieldname) :
