...
bool parse_options(int argc, char * argv[])
{
  ...
  desc.add_options()
    ...
    ("condition,c",po::value(&options.condition),
...
void parse_condition(string & theVariable,
					 string & theComparison,
					 string & theValue)
{
...
void isosegment_center(double theX1, double theY1,
					   double theX2, double theY2,
...
float isosegment_distance(double theX, double theY,
