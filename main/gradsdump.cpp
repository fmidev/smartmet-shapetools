...
int domain(int argc, const char *argv[]) {
  ...
  while (in >> noskipws >> record_type >> record_level >> record_points) {
    ...
    if (record_type == 1) {
      ...
      cout << "# Record start level = " << static_cast<int>(record_level)
           << endl
           << "# Record end level = " << static_cast<int>(record_points)
           << endl;
      ...
      throw runtime_error("Record type " + NFmiStringTools::Convert(
